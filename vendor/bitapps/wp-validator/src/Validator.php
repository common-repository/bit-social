...
namespace BitApps\Social\Deps\BitApps\WPValidator;

use BitApps\Social\Deps\BitApps\WPValidator\Exception\MethodNotFoundException;
use BitApps\Social\Deps\BitApps\WPValidator\Exception\RuleErrorException;
